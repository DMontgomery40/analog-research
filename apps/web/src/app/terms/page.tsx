...
const sections: TermsSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'TO THE MAXIMUM EXTENT PERMITTED BY LAW, ANALOG_RESEARCH, LLC AND ITS AFFILIATES ARE NOT LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR FOR LOST PROFITS, REVENUE, DATA, OR GOODWILL.',
      'TO THE MAXIMUM EXTENT PERMITTED BY LAW, OUR AGGREGATE LIABILITY FOR CLAIMS ARISING FROM OR RELATED TO THE SERVICES WILL NOT EXCEED THE GREATER OF (A) FEES PAID TO ANALOG_RESEARCH BY YOU IN THE 12 MONTHS BEFORE THE EVENT GIVING RISE TO THE CLAIM OR (B) USD $100.',
    ],
  },
  {
