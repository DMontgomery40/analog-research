...
## Fix
Set Netlify prod env for `@analoglabor/web`:
...
## Verification
- `https://api.analoglabor.com/.well-known/oauth-protected-resource` returns RFC9728 metadata
- ChatGPT app uses `https://api.analoglabor.com/v1/mcp/chatgpt` with `Mixed` auth
