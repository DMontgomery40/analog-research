...
async def run_test():
    ...
    try:
        ...
        # -> Open the Login page/form by clicking the Login link on the homepage.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/div[2]/nav/div/div[2]/a[1]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Fill the admin email and password into the login form and submit to authenticate as admin.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Send GET request to /api/v1/admin/disputes and extract the response body to verify admin can list disputes.
